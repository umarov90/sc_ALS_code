...
for entry in os.scandir(wd):
    if entry.is_dir():
        ...
        with open(f"{sd}/temp/job{i}", 'w+') as f:
            ...
            # f.write(f"samtools sort -t CB -O BAM -m 20G --verbosity 100 -o {wd}/{directory_name}/outs/cellsorted_possorted_genome_bam.bam {wd}/{directory_name}/outs/possorted_genome_bam.bam\n")
