...
if __name__ == '__main__':
    ...
    barcode_cluster_dask_df = dd.from_pandas(barcode_cluster_df, npartitions=4)

    # Step 2: Merge with 'sm' DataFrame
    dask_df = dd.from_pandas(sm, npartitions=4)
    ...
    for key in all_dfs.keys():
        ...
        all_dfs[key].to_csv(params.folder + f"tracks/{sample_id}_{key}.bed.gz",
